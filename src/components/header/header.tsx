...
useEffect(() => {
    ...
    return (
        <div className="flex items-center md:py-2 px-5 w-full overflow-hidden h-[9%] bg-[#4682B4] relative">
            <div className="flex-shrink-0 md:ml-[2%] lg:ml-[1%] w-[60px] md:w-auto py-2 xs:py-1 ">
                <img src={Logo} alt="logo" onClick={handleClick} className=' w-[80px] h-[35px] md:h-[40px] cursor-pointer hover:scale-110 transition-transform duration-300'/>
            </div>
            ...
            <div className="absolute flex left-[53%] md:left-[68%] lg:left-[76%] w-[50%] md:w-[30%] items-center">
                <div className=" mt-[20%] sm:mt-[17%] lg:mt-0 w-[18%] md:w-[14%] h-[10%] md:h-[14%] pb-9 lg:pb-0 pl-2 md:pl-0 md:px-1">
